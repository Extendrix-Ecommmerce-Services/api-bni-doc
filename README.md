...
4. [Endpoint: Pagos (REP)](#endpoint-pagos-rep)
...
**Endpoint:** `GET /api/bni/pagos`

**Descripción:** Consulta pagos (REP - Recibo Electrónico de Pago) registrados en el sistema con filtros opcionales.
...
| fecha_desde  | string  | ❌ No      | Fecha inicial (YYYY-MM-DD)    | 2025-01-01       |
| fecha_hasta  | string  | ❌ No      | Fecha final (YYYY-MM-DD)      | 2025-12-31       |
| uuid         | string  | ❌ No      | UUID del REP (folio_fiscal)   | B2C3D4E5-F6G7... |
| folio        | string  | ❌ No      | Folio del REP                 | REP-2025-00145   |
| partner_vat  | string  | ❌ No      | RFC del cliente/proveedor     | BNA020202BBB     |
| payment_type | string  | ❌ No      | Tipo de pago                  | inbound          |
| estado       | string  | ❌ No      | Estado del REP                | pago_correcto    |
| limit        | integer | ❌ No      | Máximo de resultados (1-1000) | 50               |
| offset       | integer | ❌ No      | Desplazamiento                | 0                |
...
| Código   | Descripción              |
|----------|--------------------------|
| inbound  | Pago de cliente (cobro)  |
| outbound | Pago de proveedor (pago) |
...
| pago_correcto      | REP timbrado correctamente |
...
```
Method: GET
URL: https://miembros.bnibajio.com/api/bni/pagos?fecha_desde=2025-01-01&fecha_hasta=2025-12-31&payment_type=inbound&estado=pago_correcto&limit=10
Headers:
  Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9...
```
...
```json
{
  ...
  "pagos": [
    {
      "id": 24,
      "name": "PSTP/2025/00013",
      "folio": "",
      "number_folio": "PSTP202500013",
      "date": "2025-11-20",
      "fecha_pago": "",
      "fecha_certificacion": "",
      "payment_type": "inbound",
      "payment_type_descripcion": "Pago de cliente",
      "state": "posted",
      "estado_pago": "pago_no_enviado",
      "estado_pago_descripcion": "REP no generado",
      "amount": 5560.0,
      "amount_signed": 5560.0,
      "amount_company_currency_signed": 5560.0,
      "amount_to_text": "CINCO MIL QUINIENTOS SESENTA PESOS 00/100 M. N.",
      "currency_id": "MXN",
      "monedap": "",
      "tipocambiop": "",
      "company_currency_id": "MXN",
      "partner_id": 77,
      "partner_name": "Juan Gilberto Prado Rangel",
      "partner_vat": "",
      "forma_pago_id": "",
      "forma_pago_descripcion": "",
      "methodo_pago": "",
      "methodo_pago_descripcion": false,
      "cuenta_emisor": "",
      "banco_emisor": "",
      "rfc_banco_emisor": "",
      "numero_operacion": "",
      ...
      "confirmacion": "",
      "ref": "STP1947168961",
      "communication": "STP1947168961",
      "company_id": 1,
      "company_name": "REFERENCIAS Y NETWORKING",
      "facturas_relacionadas": [],
      "numero_facturas_relacionadas": 0,
      "bills_relacionados": [],
      "attachments": []
    }
  ],
  "response_time": 0.054,
  "timestamp": "2025-11-24T12:23:47.470150"
}
```

#### Campos del Pago Detallados

##### Información Básica

- **id**: ID interno del pago en Odoo
- **name**: Número del pago (ej: BNK1/2025/00145)
- **folio**: Folio del REP
- **number_folio**: Número de folio calculado

##### Fechas

- **date**: Fecha contable del pago
- **fecha_pago**: Fecha de pago
- **fecha_certificacion**: Fecha de certificación SAT

##### Tipo y Estado

- **payment_type**: Tipo de pago (inbound/outbound/transfer)
- **state**: Estado Odoo (draft/posted/sent/reconciled/cancelled)
- **estado_pago**: Estado del REP en el SAT

##### Montos

- **amount**: Monto del pago
- **amount_signed**: Monto con signo
- **amount_company_currency_signed**: Monto en moneda de compañía
- **amount_to_text**: Monto en letra

##### Partner

- **partner_id**: ID del cliente/proveedor
- **partner_name**: Nombre del cliente/proveedor
- **partner_vat**: RFC del cliente/proveedor

##### Información de Pago

- **forma_pago_id**: Código SAT forma de pago (01-99)
- **methodo_pago**: Método de pago (PUE/PPD)

##### Bancos

- **cuenta_emisor**: Cuenta bancaria emisora
- **banco_emisor**: Nombre banco emisor
- **rfc_banco_emisor**: RFC banco emisor
- **cuenta_beneficiario**: Cuenta beneficiario
- **banco_receptor**: Nombre banco receptor
- **rfc_banco_receptor**: RFC banco receptor

##### Datos CFDI (REP)

- **folio_fiscal**: UUID del REP
- **numero_cetificado**: Número certificado digital
- **cetificaso_sat**: Certificado SAT
- **selo_digital_cdfi**: Sello digital CFDI
- **selo_sat**: Sello SAT
- **cadena_origenal**: Cadena original del complemento de certificación
- **codigo_qr**: URL QR para verificación

##### Facturas Relacionadas

Lista de facturas que se pagan con este REP, incluyendo:

- Datos de la factura
- Montos del pago aplicado
- Número de parcialidad
- Saldos anterior e insoluto

##### Archivos Adjuntos

- XML del REP (con contenido en base64)
